...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Immerss Tracking Order",
  "categories": ["SALES"],
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "Insert immerss tracking order code",
  "containerContexts": [
    "WEB"
  ]
}
...
const successHandler = function() {
  log('ImmerssTrackingOrder: Success loaded.');
  callInWindow('imrsTrackingOrderLoaded');
  data.gtmOnSuccess();
};

const failureHandler = function() {
  log('ImmerssTrackingOrder: Loaded with failure!');
  data.gtmOnFailure();
};

const url = 'https://portal.immerss.live/vece/affiliate/v1/tracking/' + encodeUriComponent(data.appId) + '/order.js';
log('ImmerssTrackingOrder:buildedUrl', url);
            ...
            "listItem": [
              {
                ...
                "mapValue": [
                  {
                    "type": 1,
                    "string": "imrsTrackingOrderLoaded"
                  },
                  {
                    "type": 8,
                    "boolean": true
...
Created on 28.06.2022, 15:39:20
